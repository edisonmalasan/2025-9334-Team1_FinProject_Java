...
public abstract class AdminServicePOA extends org.omg.PortableServer.Servant
 implements WhatsTheWord.client.admin.AdminServiceOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       {
         WhatsTheWord.client.admin.AdminRequestType type = WhatsTheWord.client.admin.AdminRequestTypeHelper.read (in);
         WhatsTheWord.referenceClasses.Admin admin = WhatsTheWord.referenceClasses.AdminHelper.read (in);
         WhatsTheWord.client.ClientCallback adminCallback = WhatsTheWord.client.ClientCallbackHelper.read (in);
